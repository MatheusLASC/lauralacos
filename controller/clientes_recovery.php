...
if(isset($_POST['cli_email'])){
	...
	if($cliente->GetClienteEmail($cliente->getCli_email()) > 0){
		...
		$email = new EnviarEmail();
     	...
     	echo'<h1 class="alert alert-success"> <p>Olá, foi enviada uma nova senha para acesso ao site em seu email de cadastro!!</p></h1>';
     	Rotas::Redirecionar(5, Rotas::pag_ClienteLogin());


	}else{
		echo'<h1 class="alert alert-danger"> <p>Este email não está cadastrado na loja!</p></h1>';

...
//Classe pronta para pagamentos pelo PagSeguro (Substituindo a API)
class PagamentoPS extends Conexao{
    ...
    public function Pagamento($cliente = array(), $pedido = array(), $produtos = array()) {
        ...
        $dados['senderName']    = $cliente['cli_nome'];
        $dados['senderAreaCode']  = $cliente['cli_ddd'];
        $dados['senderPhone']    = $cliente['cli_telefone'];
        ...
        foreach ($produtos as $item):
             ...
             $dados['itemId'.$i]          = $item['proc_id'];
             $dados['itemDescription'.$i] = $item['proc_nome'];
             $dados['itemAmount'.$i]      = $item['proc_valor_us'];
             $dados['itemQuantity'.$i]    = $item['proc_qtd'];
